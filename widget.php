...
echo '<tr><td><b>Gravatar rating:</b></td>
		<td><select style="width:50px;" id="DMSGuestbook_gravatar_rating" name="DMSGuestbook_gravatar_rating">';
...
echo '<tr><td><b>Gravatar size:</b></td>
		<td><input style="width:50px;" id="DMSGuestbook_gravatar_size" name="DMSGuestbook_gravatar_size" type="text" value="'.str_replace("\\", "", $options['gravatar_size']).'" />pixel</td><tr>';
