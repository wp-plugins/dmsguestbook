...
$data = $dataS . $data;
		...
		<br /><i style="font-zize:0.8em;">This will be shown on top of you widget.</i><br /><br />';

		echo "<b>Page id</b><br />";
		echo '<select class="widefat" id="DMSGuestbook_guestbook_id" name="DMSGuestbook_guestbook_id">' . $data . '</select>
		<br /><i style="font-zize:0.8em;"> Which guestbook would you like to display on your sidebar?</i><br /><br />';

		echo "<b>Number</b><br />";
		echo '<input style="width:30px;" type="text" name="DMSGuestbook_entries" value="'.$options['entries'].'">
		<br /><i style="font-zize:0.8em;">How many guestbook entries do you want to see on your widget?</i><br /><br />';

		echo "<b>Lenght</b><br />";
		echo '<input style="width:30px;" type="text" name="DMSGuestbook_wordcut" value="'.$options['wordcut'].'">
		<br /><i style="font-zize:0.8em;">Cut message text after X characters.</i><br /><br />';

		echo "<b>Date</b><br />";
		echo '<input class="widefat" type="text" name="DMSGuestbook_dateformat" value="'.$options['dateformat'].'">
		<br /><i style="font-zize:0.8em;">Set the date and time format.<br />More infos:
		...
		echo "<b>Gravatar rating & Gravatar size</b><br />";
		...
		echo "Use <a href='http://w3schools.com/html/default.asp' target='_blank'>HTML</a> &
		<a href='http://www.w3.org/Style/CSS/learning' target='_blank'>CSS</a> elements to customize your settings.<br />
		Don't forget to close all tags!<br /><br />";

		echo "<span style='font-size:0.8em;'
		<a id='default_widget'>Default</a> |
		<a id='example_widget1'>Example #1</a> |
		<a id='example_widget2'>Example #2</a> |
		<a id='example_widget3'>Example #3</a> |
		<a id='example_widget4'>Example #4</a> |
		<a id='example_widget5'>Example #5</a>
		</span><br /><br />";
...
<?php
		...
		echo "<span style='font-size:0.8em;'><br /><b style='font-size:16px;text-decoration: underline;'>Options</b><br />
		...
		<br />
		<b>GRAVATAR</b> - Show gravatar image if available<br />
		Example: <i style='color:#dd0000;'>This is my gravatar image: GRAVATAR</i><br />
		<br /></span>";
	}
