...
---------------------------------------------------------------------------*/
		...
		$var_form2 = "
				...
				<input class='css_form_namefield' type='text' name='gbname' value='$gbname' maxlength='50' />&nbsp;$lang_name $var_mandatory_char</div>

				<!-- email field -->
				<div class='css_form_textfieldspace'>
				<input class='css_form_emailfield' type='text' name='gbemail' value='$gbemail' />&nbsp;$lang_email $var_mandatory_email</div>
				";
		...
		$var_form3 = "
				...
				<div class='css_form_textfieldspace'>
				<input class='css_form_emailfield' type='text' name='gbgravataremail' value='$gbgravataremail' />&nbsp;Gravatar $lang_email <a href='http://en.gravatar.com/' target='_blank'>[?]</a></div>
				";
		...
		$var_form4 = "
				<!-- url field -->
				<div class='css_form_textfieldspace'>
				<input class='css_form_urlfield' type='text' name='gburl' value='$gburl' />&nbsp;$lang_url $var_mandatory_url</div>

				<!-- message field -->
				<div class='css_form_textfieldspace'>
				<textarea class='css_form_messagefield' name='gbmsg' rows='0' cols='0'>$gbmsg</textarea>&nbsp;$lang_message $var_mandatory_char</div>

				<!-- require text and the requirement char -->
				<div style='text-align:left;'>$var_mandatory_char $lang_require</div>
				<br />
				";
