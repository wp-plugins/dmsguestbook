...
define('DMSGUESTBOOKVERSION', "1.10.0");
	...
	update_option("DMSGuestbook_options", mysql_real_escape_string($restore));
...
echo $options["missing_options"];
	/* if option(s) are missing */
	if($_SESSION["missing_options"]) {
	missing_options();
	}
...
echo "<div id='outer'>
	...
	echo "<div class='dbx-box'>
				<div class='dbx-handle' title='DMSGuestbook Database'>DMSGuestbook Database</div>
	...
	echo "<div class='dbx-box'>
				<div class='dbx-handle' title='DMSGuestbook options'>DMSGuestbook options</div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
	...
	echo "<div class='dbx-box'>
				<div class='dbx-handle' title='DMSGuestbook options backup'>DMSGuestbook options backup</div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
...
echo "<div id='outer'>
	...
	echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Basic'>Basic</div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
	...
	echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Extended'>Extended</div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
	...
	echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Color'>Color</div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Time / Date'>Time / Date</div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Email Notification'>Email Notification</div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Antispam / Captcha'>Antispam / Captcha</div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Mandatory'>Mandatory</div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Miscellaneous'>Miscellaneous</div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='CSS'>CSS</div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
				<li>$return_css</li>
...
/* end of manage guestbook entries */
	...
	function insert_css() {
	    ...
	    $rep="{" . $replace_tags[$x] . "}";
	    $csscode = str_replace("$rep", $options["$replace_tags[$x]"], $csscode);
	    $csscode2 = str_replace("$rep", $options["$replace_tags[$x]"], $csscode2);
	    }

       	$csscode = str_replace("css_", ".css_", $csscode);
