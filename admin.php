...
define('DMSGUESTBOOKVERSION', "1.17.0");
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
...
?>
    ...
    <ul>
    <li>1.) <?php echo __("Create a page which you want to display the DMSGuestbook.", "dmsguestbook"); ?></li>
...
if($_REQUEST[page]=="dmsguestbook" && ($_REQUEST[dbs]!=1 && $_REQUEST[basic]!=1 && $_REQUEST[advanced]!=1)) {
	...
	echo "<table style='width:100%;' class='widefat comments' cellspacing='0'>
		...
		<tr>
			...
			<span style='font-size:8px;'>1)</span>" . __("If dmsguestbook.css is exist and writable, all CSS settings will be read from it.<br />Otherwise these settings will be load from the database.", "dmsguestbook") . "
			<br />
			<br />
...
echo "<div id='outer'>
	...
	echo "<div class='dbx-box'>
				<div class='dbx-handle' title='DMSGuestbook Database'><b style='color:#464646;'>" . __("DMSGuestbook Database", "dmsguestbook") . "</b></div>
	...
	echo "<div class='dbx-box'>
				<div class='dbx-handle' title='DMSGuestbook options'><b style='color:#464646;'>" . __("DMSGuestbook options", "dmsguestbook") . "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
	...
	echo "<div class='dbx-box'>
				<div class='dbx-handle' title='DMSGuestbook options backup'><b style='color:#464646;'>" . __("DMSGuestbook options backup", "dmsguestbook") . "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
...
while (list($key, $val) = each($options)) {
	...
	if($key == "page_id") {
		...
		//$data .= "<table style='width:95%;' border='0'><colgroup><col width='40%'><col width='55%'><col width='5%'></colgroup><tr><td>" . __("To assign guestbook(s)", "dmsguestbook") . ":</td><td>";
		...
		$data .= "<th style='font-size:9px;background-color:#cccccc;padding:2px;'>" . __("Language", "dmsguestbook") . "<br />$tmp</th>";
		...
		//$data .= "<input type='text' name='supergb_question_answer' id='supergb_question_answer' value='0'>";
		$data .= "<span style='color:#bb0000;'><br />* " . __("Would you like to have displayed different languages in just one particular guestbook? So select your desired guestbook and mark the radio button. After that all pages with an assigned language will be bound with the guestbook that you've selected.", "dmsguestbook") . "</span></td>";
...
echo "<div id='outer'>
	...
	echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Basic'><b style='color:#464646;'>" . __("Basic", "dmsguestbook") . "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
	...
	echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Extended'><b style='color:#464646;'>" . __("Extended"). "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
	...
	echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Color'><b style='color:#464646;'>" . __("Color", "dmsguestbook") . "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Time / Date'><b style='color:#464646;'>" . __("Time / Date", "dmsguestbook") . "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
				...
				<li>$return_offset</li>
				<li>&nbsp;</li>
				<li>" . __("Example", "dmsguestbook") . ": $time_example</li>
				<li>&nbsp;</li>
				</ul>
			</div>";

			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Email Notification'><b style='color:#464646;'>" . __("Email Notification", "dmsguestbook") . "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
...
<?php
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Captcha / Akismet'><b style='color:#464646;'>" . __("Captcha / Akismet", "dmsguestbook") . "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
...
<?php
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Mandatory'><b style='color:#464646;'>" . __("Mandatory", "dmsguestbook") . "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
				<li><table style='width:95%;' border='0'><colgroup><col width='40%'><col width='55%'><col width='5%'><colgroup><tr><td>" . __("Name", "dmsguestbook") . ":</td>
				<td><input type='checkbox' checked disabled></td><td style='text-align:right;'><b style='font-weight:bold;background-color:#bb1100;color:#fff;padding:3px;' onmouseover=\"Tip('" . __("User must fill out name text field", "dmsguestbook") . "')\" onclick=\"UnTip()\">?</b></td></tr></li>
				<li><table style='width:95%;' border='0'><colgroup><col width='40%'><col width='55%'><col width='5%'><colgroup><tr><td>" . __("Message", "dmsguestbook") . ":</td>
				<td><input type='checkbox' checked disabled></td><td style='text-align:right;'><b style='font-weight:bold;background-color:#bb1100;color:#fff;padding:3px;' onmouseover=\"Tip('" . __("User must fill out message text field", "dmsguestbook") . "')\" onclick=\"UnTip()\">?</b></td></tr></li>
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Gravatar'><b style='color:#464646;'>" . __("Gravatar", "dmsguestbook") . "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Miscellaneous'><b style='color:#464646;'>" . __("Miscellaneous", "dmsguestbook") . "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='Role'><b style='color:#464646;'>" , __("Role", "dmsguestbook") . "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
				<li>$return_role1</li>
				<li>$return_role2</li>
			...
			echo "<div class='dbx-box'>
				<div class='dbx-handle' title='CSS'><b style='color:#464646;'>" . __("CSS", "dmsguestbook") . "</b></div>
				<ul class='dbx-content'>
				<li>&nbsp;</li>
				<li>" . __("If dmsguestbook.css is exist and writable, all CSS settings will be read from it.<br />Otherwise these settings will be load from the database.", "dmsguestbook") . "<br />
				$css_notice<br /><br /></li>
				<li>$return_css</li>
				<li>$return_css_customize</li>
				<li>
				<b>". __("Settings for custom CSS", "dmsguestbook") . "</b><br />
				<br />
				<i>" . __("Mouse hover color", "dmsguestbook") . "</i><br />
				...
				<br />
				<i>" . __("Email and url image properties", "dmsguestbook") . "</i><br />
