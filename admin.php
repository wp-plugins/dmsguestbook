...
define('DMSGUESTBOOKVERSION', "1.7.0");
	...
	update_option("DMSGuestbook_options", $_REQUEST[restore_data]);
...
<?php
		...
		$query1 = $wpdb->get_results("SELECT * FROM  $table_name ORDER BY id $options[27] LIMIT $_REQUEST[from],$gb_step;");
...
?>
				...
				<tr><td style="height:5px;"></td></tr>
	 			...
	 			type="text" name="gb_ip" value="<?php echo $result->ip; ?>" maxlength="15">&nbsp;<a href="http://www.ripe.net/whois?searchtext=<?php echo $result->ip; ?>" target="_blank">[query]</a></td></tr>
