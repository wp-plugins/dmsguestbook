...
define('DMSGUESTBOOKVERSION', "1.16.0");
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
...
while (list($key, $val) = each($options)) {
	...
	if($key == "page_id") {
		...
		$data .= "<th style='font-size:9px;background-color:#cccccc;padding:2px;'>" . __("Guestbook", "dmsguestbook") . "</th>";
		...
		$data .= "<input id='page_id_clear' name='page_id_clear' class='button-secondary action' style='width:150px;color:#bb0000;' type='action' value='" . __("Clear all", "dmsguestbook") . "' onclick=\"PageID_Clear('$num_rows_posts')\"></td>";
