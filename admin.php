...
define('DMSGUESTBOOKVERSION', "1.3.0");
		...
		<td>
	 	 <table style="width:100%;">
			...
			<!-- guestbook form position -->
     		<tr><td <? echo $tbc1; ?>>Guestbook form position:</td>
     		<td <? echo $tbc1; ?>><select name="DMSGuestbook_formpos">
     		...
     		<td <? echo $tbc1; ?>>Visible the guestbook input form on top or bottom<br />Define a link text if you selected "bottom"</td></tr>
