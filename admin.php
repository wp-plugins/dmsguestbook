...
define('DMSGUESTBOOKVERSION', "1.5.0");
...
if($_REQUEST[basic]==1){$collaps_basic="<a href='admin.php?page=dmsguestbook&basic=0'><b>[-] Basic settings</b></a>";}
if($_REQUEST[basic]==0){$collaps_basic="<a href='admin.php?page=dmsguestbook&basic=1'>[+] Basic settings</a>";}

if($_REQUEST[advanced]==1){$collaps_advanced="<a href='admin.php?page=dmsguestbook&advanced=0'><b>[-] Advanced settings</b></a>";}
if($_REQUEST[advanced]==0){$collaps_advanced="<a href='admin.php?page=dmsguestbook&advanced=1'>[+] Advanced settings</a>";}
?>
...
if($_REQUEST[advanced]==1)
{
	...
	$handle = fopen ("../wp-content/plugins/dmsguestbook/options.php", "r");
	if(is_writable("../wp-content/plugins/dmsguestbook/options.php")) {
	echo "File is writable!<br />Set this file readonly again when your finished the customize!<br />";
	$save_advanced_button = "<input style='font-weight:bold; margin:10px 0px; width:250px;' type='submit' value='save' />";
	}
	else {
	     echo "File is not writable!<br />Set the write permission for options.php in dmsguestbook to customize this file.";
...
<?
	...
	"0","1","1","000000","%a, %e %B %Y %H:%M:%S %z","en_EN","0","top","",
	"0","name@example.com"
	);
	...
	"Ung&uuml;ltige Webseite Adresse!",
	"Text ist zu kurz!",
	...
	"Ung&uuml;ltigi Websiit&auml; Adr&auml;sse!",
	"Tegscht isch zchurz!",
	...
	// --------------------- default: english ------------------
	if ('default_english' == $POSTVARIABLE['true'])
	{
	...
	// --------------------- default: german ------------------
	if ('default_german' == $POSTVARIABLE['true'])
	{
	...
	if ('default_swissgerman' == $POSTVARIABLE['true'])
	{
	...
	if ('insert' == $POSTVARIABLE['action'])
	{
		...
		$value1 = htmlentities($POSTVARIABLE['DMSGuestbook_forwardarrowchar'], ENT_QUOTES);
		$value1 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_forwardarrowchar']);

		$value2 = htmlentities($POSTVARIABLE['DMSGuestbook_backwardarrowchar'], ENT_QUOTES);
		$value2 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_backwardarrowchar']);

		$value3 = htmlentities($POSTVARIABLE['DMSGuestbook_name'], ENT_QUOTES);
		$value3 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_name']);

		$value4 = htmlentities($POSTVARIABLE['DMSGuestbook_email'], ENT_QUOTES);
		$value4 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_email']);

		$value5 = htmlentities($POSTVARIABLE['DMSGuestbook_url'], ENT_QUOTES);
		$value5 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_url']);

		$value6 = htmlentities($POSTVARIABLE['DMSGuestbook_message'], ENT_QUOTES);
		$value6 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_message']);

		$value7 = htmlentities($POSTVARIABLE['DMSGuestbook_antispam'], ENT_QUOTES);
		$value7 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_antispam']);

		$value8 = htmlentities($POSTVARIABLE['DMSGuestbook_require'], ENT_QUOTES);
		$value8 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_require']);

		$value9 = htmlentities($POSTVARIABLE['DMSGuestbook_submit'], ENT_QUOTES);
		$value9 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_submit']);

		$value10 = htmlentities($POSTVARIABLE['DMSGuestbook_name_error'], ENT_QUOTES);
		$value10 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_name_error']);

		$value11 = htmlentities($POSTVARIABLE['DMSGuestbook_email_error'], ENT_QUOTES);
		$value11 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_email_error']);

		$value12 = htmlentities($POSTVARIABLE['DMSGuestbook_url_error'], ENT_QUOTES);
		$value12 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_url_error']);

		$value13 = htmlentities($POSTVARIABLE['DMSGuestbook_message_error'], ENT_QUOTES);
		$value13 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_message_error']);

		$value14 = htmlentities($POSTVARIABLE['DMSGuestbook_antispam_error'], ENT_QUOTES);
		$value14 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_antispam_error']);

		$value15 = htmlentities($POSTVARIABLE['DMSGuestbook_success'], ENT_QUOTES);
		$value15 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_success']);

		$value16 = htmlentities($POSTVARIABLE['DMSGuestbook_formposlink'], ENT_QUOTES);
		$value16 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_formposlink']);

		$value17 = htmlentities($POSTVARIABLE['DMSGuestbook_mail_adress'], ENT_QUOTES);
		$value17 = str_replace("\"", "&amp;quot;", $POSTVARIABLE['DMSGuestbook_mail_adress']);

    	update_option("DMSGuestbook_step",$POSTVARIABLE['DMSGuestbook_step']);
		update_option("DMSGuestbook_page_id",$POSTVARIABLE['DMSGuestbook_page_id']);
		update_option("DMSGuestbook_width",$POSTVARIABLE['DMSGuestbook_width']);
		update_option("DMSGuestbook_width2",$POSTVARIABLE['DMSGuestbook_width2']);
		update_option("DMSGuestbook_position",$POSTVARIABLE['DMSGuestbook_position']);
		update_option("DMSGuestbook_hairlinecolor",$POSTVARIABLE['DMSGuestbook_hairlinecolor']);
		update_option("DMSGuestbook_bordercolor1",$POSTVARIABLE['DMSGuestbook_bordercolor1']);
		update_option("DMSGuestbook_bordercolor2",$POSTVARIABLE['DMSGuestbook_bordercolor2']);
		update_option("DMSGuestbook_bordercolor3",$POSTVARIABLE['DMSGuestbook_bordercolor3']);
		update_option("DMSGuestbook_fontcolor1",$POSTVARIABLE['DMSGuestbook_fontcolor1']);
		update_option("DMSGuestbook_formpos",$POSTVARIABLE['DMSGuestbook_formpos']);
		update_option("DMSGuestbook_forwardarrowchar",$value1);
		update_option("DMSGuestbook_backwardarrowchar",$value2);
		update_option("DMSGuestbook_arrowsize",htmlentities($POSTVARIABLE['DMSGuestbook_arrowsize'], ENT_QUOTES));
		...
		update_option("DMSGuestbook_formposlink",$value16);

		update_option("DMSGuestbook_require_email",htmlentities($POSTVARIABLE['DMSGuestbook_require_email'], ENT_QUOTES));
		update_option("DMSGuestbook_require_url",htmlentities($POSTVARIABLE['DMSGuestbook_require_url'], ENT_QUOTES));
		update_option("DMSGuestbook_require_antispam",htmlentities($POSTVARIABLE['DMSGuestbook_require_antispam'], ENT_QUOTES));
		update_option("DMSGuestbook_show_ip",htmlentities($POSTVARIABLE['DMSGuestbook_show_ip'], ENT_QUOTES));
		update_option("DMSGuestbook_show_email",htmlentities($POSTVARIABLE['DMSGuestbook_show_email'], ENT_QUOTES));
		update_option("DMSGuestbook_show_url",htmlentities($POSTVARIABLE['DMSGuestbook_show_url'], ENT_QUOTES));
		update_option("DMSGuestbook_captcha_color",htmlentities($POSTVARIABLE['DMSGuestbook_captcha_color'], ENT_QUOTES));
		update_option("DMSGuestbook_dateformat",htmlentities($POSTVARIABLE['DMSGuestbook_dateformat'], ENT_QUOTES));
		update_option("DMSGuestbook_setlocale",htmlentities($POSTVARIABLE['DMSGuestbook_setlocale'], ENT_QUOTES));
		update_option("DMSGuestbook_offset",$POSTVARIABLE['DMSGuestbook_offset']);

		update_option("DMSGuestbook_send_mail",$POSTVARIABLE['DMSGuestbook_send_mail']);
		update_option("DMSGuestbook_mail_adress",$value17);
	...
	$handle = fopen("../wp-content/plugins/dmsguestbook/options.php", "w");
	fwrite($handle, $POSTVARIABLE['advanced_data']);
	fclose($handle);
	message("<b>saved...</b>",200,800);
	}
...
//--------------------- end of manage guestbook entries ---------------------------
	...
	function initialize_option() {
	  ...
	  if(!get_option("DMSGuestbook_offset"))				{update_option("DMSGuestbook_offset",		$option[22]);}
	  if(!get_option("DMSGuestbook_formpos"))				{update_option("DMSGuestbook_formpos",		$option[23]);}
	  if(!get_option("DMSGuestbook_formposlink"))			{update_option("DMSGuestbook_formposlink",	$option[24]);}
	  if(!get_option("DMSGuestbook_send_mail"))				{update_option("DMSGuestbook_send_mail",	$option[25]);}
	  if(!get_option("DMSGuestbook_mail_adress"))			{update_option("DMSGuestbook_mail_adress",	$option[26]);}
	...
	function default_option() {
	  ...
	  update_option("DMSGuestbook_offset",			$option[22]);
	  update_option("DMSGuestbook_formpos",			$option[23]);
	  update_option("DMSGuestbook_formposlink",		$option[24]);
	  update_option("DMSGuestbook_send_mail",		$option[25]);
	  update_option("DMSGuestbook_mail_adress",		$option[26]);
