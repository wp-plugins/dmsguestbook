...
Requirement:<br />
- Wordpress 2.x<br />
- Exec-PHP (http://bluesome.net/post/2005/08/18/50/)<br />
<br />
1.) Download the dmsguestbook.zip<br />
2.) Unpack the file and copy the whole dmsguestbook folder to the wordpress plugins folder.<br />
